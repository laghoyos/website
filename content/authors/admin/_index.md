...
education:
  - area: MSc Civil Engineering
    ...
    summary: |
      ...
      Thesis on _Calibration of Phisic-Based Model for Earthquake-induced Landslides Hazards_. Supervised by [Prof Joe Wartman](URL "https://www.ce.washington.edu/facultyfinder/joseph-wartman").
    # button:
    #   text: 'Read Thesis'
